...
function getDateRange(data: { date: string; waist: number }[]) {
...
export function WaistMeasurementLineGraph({
  title,
  description,
  waistData,
}: {
  title: string;
  description?: string;
  waistData: { date: string; waist: number }[];
}) {
  const dateRange = getDateRange(waistData);
